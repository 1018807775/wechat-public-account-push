export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe49647bf551b2960",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4429be3aab4aabcd464650cd19f6ddc0",
   ...
   */
  USERS: [oZeIE6X_ZYr0M5nF9YGMaCY5P5lI
    {
      // 想要发送的人的名字
      name: "纤纤宝贝~",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oZeIE6X_ZYr0M5nF9YGMaCY5P5lI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "GZsGndLqQtrwY_KS0CLAqsRXBrX1YBWOC_ZpGU8tmzE",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "桂林",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "伍纤纤", "year": "2002", "date": "11-18"},
        {"type": "节日", "name": "在一起的时候", "year": "2021", "date": "11-18"},
      ],
